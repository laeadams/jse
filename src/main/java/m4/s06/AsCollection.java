...
public class AsCollection {
	public static void main(String[] args) {
		Collection<Integer> collOne = new ArrayList<Integer>(); // creo l'ArrayList e ci attacco le funzionalità
		...
		// tutte le collezioni sono Iterable
		...
		Integer[] values = collOne.toArray(new Integer[collOne.size()]); // dando la size di Integer si risparmia memoria
